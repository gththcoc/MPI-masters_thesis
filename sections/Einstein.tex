...
%In the case of neutron stars, the relativistic equation for hydrostatic equilibrium, together with the matter model encoded in a cold equation of state(EOS), can tell about the star's properties like the tidal deformability(see equation \ref{Tid}), mass and radius, as well as the pressure and density profiles. 
...
Recent studies have investigated the existence of a threshold mass for realistic neutron star merger remnants \cite{Kashyap_2022}, according to the ratio
